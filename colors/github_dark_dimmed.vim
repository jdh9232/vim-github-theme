...
let s:cdFront    = {'gui': '#ADBAC7', 'cterm': s:cterm00, 'cterm256': '235'}
let s:cdBack     = {'gui': '#22272E', 'cterm': s:cterm0F, 'cterm256': '15'}
...
let s:cdPurple   = {'gui': '#DCBDFB', 'cterm': s:cterm05, 'cterm256': '98'}
let s:cdBlue     = {'gui': '#6CB6FF', 'cterm': s:cterm04, 'cterm256': '25'}
let s:cdDarkBlue = {'gui': '#96D0FF', 'cterm': s:cterm04, 'cterm256': '23'}
let s:cdGreen    = {'gui': '#8DDB8C', 'cterm': s:cterm06, 'cterm256': '22'}
let s:cdRed      = {'gui': '#F47067', 'cterm': s:cterm01, 'cterm256': '160'}
let s:cdRedDark  = {'gui': '#FFD8D3', 'cterm': s:cterm01, 'cterm256': '1'}
let s:cdOrange   = {'gui': '#F69D50', 'cterm': s:cterm01, 'cterm256': '94'}
let s:cdBrown    = {'gui': '#F69D50', 'cterm': s:cterm01, 'cterm256': '94'}
let s:cdGray     = {'gui': '#768390', 'cterm': s:cterm08, 'cterm256': '243'}
