...
let s:cdFront            = {'gui': '#ADBAC7', 'cterm': s:cterm0F, 'cterm256': '250'}
let s:cdBack             = {'gui': '#22272E', 'cterm': s:cterm00, 'cterm256': '235'}
if g:github_transparent | let s:cdBack = {'gui': 'NONE', 'cterm': 'NONE', 'cterm256': 'NONE'} | endif

let s:cdTabCurrent       = {'gui': '#22272E', 'cterm': s:cterm00, 'cterm256': '235'}
let s:cdTabOther         = {'gui': '#373E47', 'cterm': s:cterm08, 'cterm256': '237'}
let s:cdTabOutside       = {'gui': '#545D68', 'cterm': s:cterm07, 'cterm256': '59'}
let s:cdTabText          = {'gui': '#CDD9E5', 'cterm': s:cterm0F, 'cterm256': '253'}

let s:cdPopupFront       = {'gui': '#ADBAC7', 'cterm': s:cterm0F, 'cterm256': '250'}
let s:cdPopupBack        = {'gui': '#373E47', 'cterm': s:cterm08, 'cterm256': '237'}
let s:cdPopupHighlight   = {'gui': '#143D79', 'cterm': s:cterm04, 'cterm256': '24'}
let s:cdPopupScroll      = {'gui': '#ADBAC7', 'cterm': s:cterm0F, 'cterm256': '250'}
let s:cdPopupScrollBar   = {'gui': '#545D68', 'cterm': s:cterm00, 'cterm256': '59'}

let s:cdSplitFront       = {'gui': '#545D68', 'cterm': s:cterm07, 'cterm256': '59'}

let s:cdStatusLine       = {'gui': '#545D68', 'cterm': s:cterm07, 'cterm256': '59'}
let s:cdStatusLineText   = {'gui': '#CDD9E5', 'cterm': s:cterm08, 'cterm256': '253'}
let s:cdStatusLineNC     = {'gui': '#444C56', 'cterm': s:cterm07, 'cterm256': '239'}
let s:cdStatusLineNCText = {'gui': '#CDD9E5', 'cterm': s:cterm08, 'cterm256': '253'}

let s:cdCursorDark       = {'gui': '#5D1008', 'cterm': s:cterm08, 'cterm256': '52'}
let s:cdCursorLight      = {'gui': '#2D333B', 'cterm': s:cterm08, 'cterm256': '236'}

let s:cdLineNumber       = {'gui': '#768390', 'cterm': s:cterm07, 'cterm256': '8'}
let s:cdMatchParen       = {'gui': '#255AB2', 'cterm': s:cterm07, 'cterm256': '25'}

let s:cdFold             = {'gui': '#2D333B', 'cterm': s:cterm08, 'cterm256': '236'}
let s:cdFoldText         = {'gui': '#909DAB', 'cterm': s:cterm07, 'cterm256': '247'}

let s:cdSearchCurrent    = {'gui': '#245829', 'cterm': s:cterm0A, 'cterm256': '237'}
let s:cdSearch           = {'gui': '#255AB2', 'cterm': s:cterm07, 'cterm256': '25'}
let s:cdSelection        = {'gui': '#255AB2', 'cterm': s:cterm07, 'cterm256': '25'}

let s:cdDiffDeleteFg     = {'gui': '#451916', 'cterm': s:cterm0F, 'cterm256': '235'}
let s:cdDiffDeleteBg     = {'gui': '#220C0B', 'cterm': s:cterm0F, 'cterm256': '233'}
let s:cdDiffAddFg        = {'gui': '#1A331B', 'cterm': s:cterm0A, 'cterm256': '235'}
let s:cdDiffAddBg        = {'gui': '#0A160B', 'cterm': s:cterm07, 'cterm256': '233'}
let s:cdDiffChangeFg     = {'gui': '#1A355B', 'cterm': s:cterm0B, 'cterm256': '237'}
let s:cdDiffChangeBg     = {'gui': '#0A1422', 'cterm': s:cterm0F, 'cterm256': '233'}

let s:cdPurple           = {'gui': '#DCBDFB', 'cterm': s:cterm0D, 'cterm256': '183'}
let s:cdBlue             = {'gui': '#6CB6FF', 'cterm': s:cterm0C, 'cterm256': '75'}
let s:cdDarkBlue         = {'gui': '#96D0FF', 'cterm': s:cterm0C, 'cterm256': '117'}
let s:cdGreen            = {'gui': '#8DDB8C', 'cterm': s:cterm0E, 'cterm256': '114'}
let s:cdRed              = {'gui': '#F47067', 'cterm': s:cterm09, 'cterm256': '203'}
let s:cdRedDark          = {'gui': '#FFD8D3', 'cterm': s:cterm09, 'cterm256': '224'}
let s:cdOrange           = {'gui': '#F69D50', 'cterm': s:cterm09, 'cterm256': '215'}
let s:cdGray             = {'gui': '#768390', 'cterm': s:cterm07, 'cterm256': '8'}
" Syntax colors:
