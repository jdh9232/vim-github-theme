...
let s:cdFront    = {'gui': '#F0F3F6', 'cterm': s:cterm00, 'cterm256': '235'}
let s:cdBack     = {'gui': '#0A0C10', 'cterm': s:cterm0F, 'cterm256': '15'}
...
let s:cdPurple   = {'gui': '#DBB7FF', 'cterm': s:cterm05, 'cterm256': '98'}
let s:cdBlue     = {'gui': '#91CBFF', 'cterm': s:cterm04, 'cterm256': '25'}
let s:cdDarkBlue = {'gui': '#ADDCFF', 'cterm': s:cterm04, 'cterm256': '23'}
let s:cdGreen    = {'gui': '#72F088', 'cterm': s:cterm06, 'cterm256': '22'}
let s:cdRed      = {'gui': '#FF9492', 'cterm': s:cterm01, 'cterm256': '160'}
let s:cdRedDark  = {'gui': '#FFDEDB', 'cterm': s:cterm01, 'cterm256': '1'}
let s:cdOrange   = {'gui': '#FFB757', 'cterm': s:cterm01, 'cterm256': '94'}
let s:cdBrown    = {'gui': '#FFB757', 'cterm': s:cterm01, 'cterm256': '94'}
let s:cdGray     = {'gui': '#BDC4CC', 'cterm': s:cterm08, 'cterm256': '243'}
