...
let s:cdFront            = {'gui': '#F0F3F6', 'cterm': s:cterm0F, 'cterm256': '255'}
let s:cdBack             = {'gui': '#0A0C10', 'cterm': s:cterm00, 'cterm256': '232'}
if g:github_transparent | let s:cdBack = {'gui': 'NONE', 'cterm': 'NONE', 'cterm256': 'NONE'} | endif

let s:cdTabCurrent       = {'gui': '#0A0C10', 'cterm': s:cterm00, 'cterm256': '232'}
let s:cdTabOther         = {'gui': '#272B33', 'cterm': s:cterm08, 'cterm256': '236'}
let s:cdTabOutside       = {'gui': '#7A828E', 'cterm': s:cterm07, 'cterm256': '8'}
let s:cdTabText          = {'gui': '#FFFFFF', 'cterm': s:cterm0F, 'cterm256': '15'}

let s:cdPopupFront       = {'gui': '#F0F3F6', 'cterm': s:cterm0F, 'cterm256': '255'}
let s:cdPopupBack        = {'gui': '#272B33', 'cterm': s:cterm08, 'cterm256': '236'}
let s:cdPopupHighlight   = {'gui': '#1E60D5', 'cterm': s:cterm04, 'cterm256': '26'}
let s:cdPopupScroll      = {'gui': '#F0F3F6', 'cterm': s:cterm0F, 'cterm256': '255'}
let s:cdPopupScrollBar   = {'gui': '#7A828E', 'cterm': s:cterm00, 'cterm256': '8'}

let s:cdSplitFront       = {'gui': '#7A828E', 'cterm': s:cterm07, 'cterm256': '8'}

let s:cdStatusLine       = {'gui': '#7A828E', 'cterm': s:cterm07, 'cterm256': '8'}
let s:cdStatusLineText   = {'gui': '#FFFFFF', 'cterm': s:cterm08, 'cterm256': '15'}
let s:cdStatusLineNC     = {'gui': '#525964', 'cterm': s:cterm07, 'cterm256': '240'}
let s:cdStatusLineNCText = {'gui': '#FFFFFF', 'cterm': s:cterm08, 'cterm256': '15'}

let s:cdCursorDark       = {'gui': '#A91500', 'cterm': s:cterm08, 'cterm256': '124'}
let s:cdCursorLight      = {'gui': '#272B33', 'cterm': s:cterm08, 'cterm256': '236'}

let s:cdLineNumber       = {'gui': '#BDC4CC', 'cterm': s:cterm07, 'cterm256': '251'}
let s:cdMatchParen       = {'gui': '#318BF8', 'cterm': s:cterm07, 'cterm256': '69'}

let s:cdFold             = {'gui': '#272B33', 'cterm': s:cterm08, 'cterm256': '236'}
let s:cdFoldText         = {'gui': '#D9DEE3', 'cterm': s:cterm07, 'cterm256': '253'}

let s:cdSearchCurrent    = {'gui': '#008C2C', 'cterm': s:cterm0A, 'cterm256': '28'}
let s:cdSearch           = {'gui': '#318BF8', 'cterm': s:cterm07, 'cterm256': '69'}
let s:cdSelection        = {'gui': '#318BF8', 'cterm': s:cterm07, 'cterm256': '69'}

let s:cdDiffDeleteFg     = {'gui': '#4C2020', 'cterm': s:cterm0F, 'cterm256': '236'}
let s:cdDiffDeleteBg     = {'gui': '#261010', 'cterm': s:cterm0F, 'cterm256': '234'}
let s:cdDiffAddFg        = {'gui': '#0B3E17', 'cterm': s:cterm0A, 'cterm256': '234'}
let s:cdDiffAddBg        = {'gui': '#011B09', 'cterm': s:cterm07, 'cterm256': '232'}
let s:cdDiffChangeFg     = {'gui': '#1A3F66', 'cterm': s:cterm0B, 'cterm256': '23'}
let s:cdDiffChangeBg     = {'gui': '#0A1826', 'cterm': s:cterm0F, 'cterm256': '234'}

let s:cdPurple           = {'gui': '#DBB7FF', 'cterm': s:cterm0D, 'cterm256': '183'}
let s:cdBlue             = {'gui': '#91CBFF', 'cterm': s:cterm0C, 'cterm256': '117'}
let s:cdDarkBlue         = {'gui': '#ADDCFF', 'cterm': s:cterm0C, 'cterm256': '153'}
let s:cdGreen            = {'gui': '#72F088', 'cterm': s:cterm0E, 'cterm256': '84'}
let s:cdRed              = {'gui': '#FF9492', 'cterm': s:cterm09, 'cterm256': '210'}
let s:cdRedDark          = {'gui': '#FFDEDB', 'cterm': s:cterm09, 'cterm256': '224'}
let s:cdOrange           = {'gui': '#FFB757', 'cterm': s:cterm09, 'cterm256': '215'}
let s:cdGray             = {'gui': '#BDC4CC', 'cterm': s:cterm07, 'cterm256': '251'}
" Syntax colors:
