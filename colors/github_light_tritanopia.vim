...
let s:cdTabCurrent       = {'gui': '#24292F', 'cterm': s:cterm00, 'cterm256': '235'}
let s:cdTabOther         = {'gui': '#6E7781', 'cterm': s:cterm08, 'cterm256': '243'}
let s:cdTabOutside       = {'gui': '#AFB8C1', 'cterm': s:cterm0F, 'cterm256': '250'}
let s:cdTabText          = {'gui': '#F6F8FA', 'cterm': s:cterm0F, 'cterm256': '15'}

let s:cdPopupFront       = {'gui': '#24292F', 'cterm': s:cterm08, 'cterm256': '235'}
let s:cdPopupBack        = {'gui': '#EAEEF2', 'cterm': s:cterm0F, 'cterm256': '255'}
let s:cdPopupHighlight   = {'gui': '#B6E3FF', 'cterm': s:cterm07, 'cterm256': '153'}
let s:cdPopupScroll      = {'gui': '#24292F', 'cterm': s:cterm07, 'cterm256': '235'}
let s:cdPopupScrollBar   = {'gui': '#D0D7DE', 'cterm': s:cterm08, 'cterm256': '188'}

let s:cdSplitFront       = {'gui': '#6E7781', 'cterm': s:cterm07, 'cterm256': '243'}

let s:cdStatusLine       = {'gui': '#424A53', 'cterm': s:cterm07, 'cterm256': '239'}
let s:cdStatusLineText   = {'gui': '#F6F8FA', 'cterm': s:cterm08, 'cterm256': '15'}
let s:cdStatusLineNC     = {'gui': '#D0D7DE', 'cterm': s:cterm07, 'cterm256': '188'}
let s:cdStatusLineNCText = {'gui': '#24292F', 'cterm': s:cterm08, 'cterm256': '235'}

let s:cdCursorDark       = {'gui': '#FFF0EB', 'cterm': s:cterm07, 'cterm256': '255'}
let s:cdCursorLight      = {'gui': '#EAEEF2', 'cterm': s:cterm0F, 'cterm256': '255'}

let s:cdLineNumber       = {'gui': '#6E7781', 'cterm': s:cterm08, 'cterm256': '243'}
let s:cdMatchParen       = {'gui': '#B6E3FF', 'cterm': s:cterm07, 'cterm256': '153'}

let s:cdFold             = {'gui': '#F6F8FA', 'cterm': s:cterm07, 'cterm256': '15'}
let s:cdFoldText         = {'gui': '#424A53', 'cterm': s:cterm08, 'cterm256': '239'}

let s:cdSearchCurrent    = {'gui': '#80CCFF', 'cterm': s:cterm02, 'cterm256': '117'}
let s:cdSearch           = {'gui': '#B6E3FF', 'cterm': s:cterm04, 'cterm256': '153'}
let s:cdSelection        = {'gui': '#B6E3FF', 'cterm': s:cterm04, 'cterm256': '153'}

let s:cdDiffDeleteFg     = {'gui': '#FFCDCD', 'cterm': s:cterm00, 'cterm256': '224'}
let s:cdDiffDeleteBg     = {'gui': '#FFF5F4', 'cterm': s:cterm00, 'cterm256': '224'}
let s:cdDiffAddFg        = {'gui': '#BBDFFF', 'cterm': s:cterm0A, 'cterm256': '153'}
let s:cdDiffAddBg        = {'gui': '#EEFAFF', 'cterm': s:cterm08, 'cterm256': '194'}
let s:cdDiffChangeFg     = {'gui': '#BBDFFF', 'cterm': s:cterm0B, 'cterm256': '153'}
let s:cdDiffChangeBg     = {'gui': '#DDF4FF', 'cterm': s:cterm00, 'cterm256': '195'}
...
let s:cdOrange           = {'gui': '#A40E26', 'cterm': s:cterm01, 'cterm256': '124'}
