...
let s:cdDiffDeleteFg       = {'gui': '#FFCDCD', 'cterm': s:cterm0F, 'cterm256': '160'}
let s:cdDiffDeleteBg       = {'gui': '#FFF5F4', 'cterm': s:cterm0F, 'cterm256': '255'}
...
let s:cdOrange             = {'gui': '#A40E26', 'cterm': s:cterm01, 'cterm256': '94'}
