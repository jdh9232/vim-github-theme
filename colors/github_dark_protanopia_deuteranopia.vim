...
let s:cdGreen    = {'gui': '#A5D6FF', 'cterm': s:cterm06, 'cterm256': '22'}
let s:cdRed      = {'gui': '#EC8E2C', 'cterm': s:cterm01, 'cterm256': '160'}
let s:cdRedDark  = {'gui': '#FFE2BB', 'cterm': s:cterm01, 'cterm256': '1'}
let s:cdOrange   = {'gui': '#FDAC54', 'cterm': s:cterm01, 'cterm256': '94'}
let s:cdBrown    = {'gui': '#FDAC54', 'cterm': s:cterm01, 'cterm256': '94'}
