...
target_r = int(target[1:3],16)
target_g = int(target[3:5],16)
target_b = int(target[5:7],16)

min_diff = 0
min_index = 0

for i in range(len(colors)):
    temp_color = colors[i][2]
    r3 = (target_r - int(temp_color[1:3],16))/256
    g3 = (target_g - int(temp_color[3:5],16))/256
    b3 = (target_b - int(temp_color[5:7],16))/256

    temp_diff = math.sqrt(r3*r3 + g3*g3 + b3*b3)
